...
public :
   ...
   FilterData(std::string a_path,std::string a_target,std::string a_beam_en, TTree *tree=0);
   virtual ~FilterData();
...
FilterData::FilterData(std::string a_path, std::string a_target, std::string a_beam_en, TTree *tree) : fChain(0)
{
...
Int_t FilterData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t FilterData::LoadTree(Long64_t entry)
{
...
void FilterData::Init(TTree *tree)
{
...
void FilterData::Show(Long64_t entry)
{
...
Int_t FilterData::Cut(Long64_t entry)
{
