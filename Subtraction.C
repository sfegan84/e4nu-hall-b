...
void Subtraction::rot_2pi_1p (TVector3 V3_pi[2], double qpi[2], TVector3 V3_prot, TVector3 V3_q, double N1pi1p[2], double *N2pi1p, int N_total)
{
  ...
  for(int g=0; g<N_total; g++)
    ...
    rot_angle=gRandom->Uniform(0,2*TMath::Pi());
        ...
        for(int z=0;z<2;z++)
          {
            if(qpi[z]>0) pi2_stat[z]=PiplFiducialCut(fbeam_en, V3_2pi_rot[z], &cphil, &cphir);
            else  pi2_stat[z]=PimiFiducialCut(fbeam_en,V3_2pi_rot[z], &pimi_phimin, &pimi_phimax);
          }
        if(PFiducialCut(fbeam_en,V3_p_rot) &&  pi2_stat[0] && !pi2_stat[1])  N1pi1p[0]=N1pi1p[0]+1;
        if(PFiducialCut(fbeam_en,V3_p_rot) && !pi2_stat[0] &&  pi2_stat[1])  N1pi1p[1]=N1pi1p[1]+1;
        if(PFiducialCut(fbeam_en,V3_p_rot) &&  pi2_stat[0] &&  pi2_stat[1])  N_all=N_all+1;
...
void Subtraction::rot_1pi_2p (TVector3 V3_pi, double qpi, TVector3 V3_prot[2], TVector3 V3_q, double N1pi1p[2], double *N1pi2p, int N_total)
{
  ...
  for(int g=0; g<N_total; g++)
    ...
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) &&  pi_stat)  N_all=N_all+1;
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && !PFiducialCut(fbeam_en,V3_p_rot[1]) &&  pi_stat)  N1pi1p[0]=N1pi1p[0]+1;
    if(!PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) &&  pi_stat)  N1pi1p[1]=N1pi1p[1]+1;
  }
...
void Subtraction::rot_1pi_3p(TVector3 V3_pi, double qpi, TVector3 V3_prot[3], TVector3 V3_q, double N1pi1p[3], double N1pi2p[3], double *N1pi3p, int N_total)
{
  ...
  for(int g=0; g<N_total; g++)
  {
    ...
    V3_p_rot[2].Rotate(rot_angle, V3_q);
      ...
      if(PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat) N_all = N_all+1;
      if(PFiducialCut(fbeam_en,V3_p_rot[0]) && !PFiducialCut(fbeam_en,V3_p_rot[1]) && !PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat) N1pi1p[0]=N1pi1p[0]+1;
      if(!PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && !PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat) N1pi1p[1]=N1pi1p[1]+1;
      if(!PFiducialCut(fbeam_en,V3_p_rot[0]) && !PFiducialCut(fbeam_en,V3_p_rot[1]) && PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat) N1pi1p[2]=N1pi1p[2]+1;
      if(PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && !PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat) N1pi2p[0]=N1pi2p[0]+1;
      if(PFiducialCut(fbeam_en,V3_p_rot[0]) && !PFiducialCut(fbeam_en,V3_p_rot[1]) && PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat) N1pi2p[1]=N1pi2p[1]+1;
      if(!PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat) N1pi2p[2]=N1pi2p[2]+1;
  }
  *N1pi3p = N_all;
}
...
void Subtraction::rot_3pi_1p(TVector3 V3_pi[3], double qpi[3], TVector3 V3_prot, TVector3 V3_q, double N1pi1p[3], double N2pi1p[3], double *N3pi1p, int N_total)
{
  ...
  for(int g=0; g<N_total; g++)
  {
    ...
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat[0] && pi_stat[1] && pi_stat[2]) N_all = N_all+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat[0] && !pi_stat[1] && !pi_stat[2]) N1pi1p[0]=N1pi1p[0]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && !pi_stat[0] && pi_stat[1] && !pi_stat[2]) N1pi1p[1]=N1pi1p[1]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && !pi_stat[0] && !pi_stat[1] && pi_stat[2]) N1pi1p[2]=N1pi1p[2]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat[0] && pi_stat[1] && !pi_stat[2]) N2pi1p[0]=N2pi1p[0]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat[0] && !pi_stat[1] && pi_stat[2]) N2pi1p[1]=N2pi1p[1]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && !pi_stat[0] && pi_stat[1] && pi_stat[2]) N2pi1p[2]=N2pi1p[2]+1;
  }
  *N3pi1p = N_all;
}
...
void Subtraction::rot_1phot_1pi_1p(TVector3 V3_phot, TVector3 V3_pi, double qpi, TVector3 V3_prot, TVector3 V3_q, bool radstat, double *N1pi1p0phot, double *N1pi1p1phot, int N_total)
{
  ...
  for(int g=0; g<N_total; g++)
  {
    ...
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat && phot_stat) N_all = N_all+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat && !phot_stat) N_1pi_1p_0phot = N_1pi_1p_0phot+1;
  }
...
void Subtraction::rot_1phot_1pi_2p(TVector3 V3_phot, TVector3 V3_pi, double qpi, TVector3 V3_prot[2], TVector3 V3_q, bool radstat, double N1pi1p0phot[2], double N1pi1p1phot[2], double *N1pi2p0phot, double *N1pi2p1phot, int N_total)
{
  ...
  for(int g=0; g<N_total; g++)
  {
    ...
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && pi_stat && phot_stat) N_all = N_all+1;
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && !PFiducialCut(fbeam_en,V3_p_rot[1]) && pi_stat && !phot_stat) N1pi1p0phot[0] = N1pi1p0phot[0]+1;
    if(!PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && pi_stat && !phot_stat) N1pi1p0phot[1] = N1pi1p0phot[1]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && !PFiducialCut(fbeam_en,V3_p_rot[1]) && pi_stat && phot_stat) N1pi1p1phot[0] = N1pi1p1phot[0]+1;
    if(!PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && pi_stat && phot_stat) N1pi1p1phot[1] = N1pi1p1phot[1]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && pi_stat && !phot_stat) N_1pi_2p_0phot = N_1pi_2p_0phot+1;
  }
  *N1pi2p1phot = N_all;
...
void Subtraction::rot_2phot_1pi_1p(TVector3 V3_phot[2], TVector3 V3_pi, double qpi, TVector3 V3_prot, TVector3 V3_q, bool radstat[2], double *N1pi1p0phot, double *N1pi1p1phot, double *N1pi1p2phot, int N_total)
{
  ...
  for(int g=0; g<N_total; g++)
  {
    ...
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat && phot_stat[0] && phot_stat[1]) N_all = N_all+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat && !phot_stat[0] && !phot_stat[1]) N_1pi_1p_0phot = N_1pi_1p_0phot+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat && phot_stat[0] && !phot_stat[1]) N_1pi_1p_1phot = N_1pi_1p_1phot+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat && !phot_stat[0] && phot_stat[1]) N_1pi_1p_1phot = N_1pi_1p_1phot+1;
  }
  *N1pi1p0phot = N_1pi_1p_0phot;
...
void Subtraction::rot_1phot_2pi_1p(TVector3 V3_phot, TVector3 V3_pi[2], double qpi[2], TVector3 V3_prot, TVector3 V3_q, bool radstat, double N1pi1p0phot[2], double N1pi1p1phot[2], double *N2pi1p0phot, double *N2pi1p1phot, int N_total)
{
  ...
  for(int g=0; g<N_total; g++)
  {
    ...
    for(int i=0; i<2; i++)
    {
      if(qpi[i]>0) pi_stat[i] = PiplFiducialCut(fbeam_en,V3_pi_rot[i], &cphil, &cphir);
      else pi_stat[i] = PimiFiducialCut(fbeam_en,V3_pi_rot[i], &pimi_phimin, &pimi_phimax);
    }
    ...
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat[0] && pi_stat[1] && phot_stat) N_all = N_all+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat[0] && !pi_stat[1] && phot_stat) N1pi1p1phot[0] = N1pi1p1phot[0]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && !pi_stat[0] && pi_stat[1] && phot_stat) N1pi1p1phot[1] = N1pi1p1phot[1]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat[0] && pi_stat[1] && !phot_stat) N_2pi_1p_0phot = N_2pi_1p_0phot+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat[0] && !pi_stat[1] && !phot_stat) N1pi1p0phot[0] = N1pi1p0phot[0]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot) && pi_stat[0] && !pi_stat[1] && !phot_stat) N1pi1p0phot[1] = N1pi1p0phot[1]+1;
  }
  *N2pi1p1phot = N_all;
...
void Subtraction::rot_1phot_1pi_3p(TVector3 V3_phot, TVector3 V3_pi, double qpi, TVector3 V3_prot[3], TVector3 V3_q, bool radstat, double N1pi1p0phot[3], double N1pi1p1phot[3], double N1pi2p0phot[3], double N1pi2p1phot[3], double *N1pi3p1phot, double *N1pi3p0phot, int N_total)
{
  ...
  for(int g=0; g<N_total; g++)
  {
    ...
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && phot_stat) N_all = N_all+1;
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && !PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && phot_stat) N1pi2p1phot[0] = N1pi2p1phot[0]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && !PFiducialCut(fbeam_en,V3_p_rot[1]) && PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && phot_stat) N1pi2p1phot[1] = N1pi2p1phot[1]+1;
    if(!PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && phot_stat) N1pi2p1phot[2] = N1pi2p1phot[2]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && !phot_stat) N_1pi_3p_0phot = N_1pi_3p_0phot+1;
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && !PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && !phot_stat) N1pi2p0phot[0] = N1pi2p0phot[0]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && !PFiducialCut(fbeam_en,V3_p_rot[1]) && PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && !phot_stat) N1pi2p0phot[1] = N1pi2p0phot[1]+1;
    if(!PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && !phot_stat) N1pi2p0phot[2] = N1pi2p0phot[2]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && !PFiducialCut(fbeam_en,V3_p_rot[1]) && !PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && phot_stat) N1pi1p1phot[0] = N1pi1p1phot[0]+1;
    if(!PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && !PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && phot_stat) N1pi1p1phot[1] = N1pi1p1phot[1]+1;
    if(!PFiducialCut(fbeam_en,V3_p_rot[0]) && !PFiducialCut(fbeam_en,V3_p_rot[1]) && PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && phot_stat) N1pi1p1phot[2] = N1pi1p1phot[2]+1;
    if(PFiducialCut(fbeam_en,V3_p_rot[0]) && !PFiducialCut(fbeam_en,V3_p_rot[1]) && !PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && !phot_stat) N1pi1p0phot[0] = N1pi1p0phot[0]+1;
    if(!PFiducialCut(fbeam_en,V3_p_rot[0]) && PFiducialCut(fbeam_en,V3_p_rot[1]) && !PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && !phot_stat) N1pi1p0phot[1] = N1pi1p0phot[1]+1;
    if(!PFiducialCut(fbeam_en,V3_p_rot[0]) && !PFiducialCut(fbeam_en,V3_p_rot[1]) && PFiducialCut(fbeam_en,V3_p_rot[2]) && pi_stat && !phot_stat) N1pi1p0phot[2] = N1pi1p0phot[2]+1;
  }
  *N1pi3p1phot = N_all;
