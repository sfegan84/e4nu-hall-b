...
struct Fiducial {
  ...
  Bool_t KplFiducialCut(std::string beam_en, TVector3 momentum,Float_t *philow,Float_t *phiup);
  ...
  const Double_t fid_1gev_750_efid_S3[4][2][4] = {{{17.1438 , 5.82672 , -1.33914 , 0.370319},
						  ...
						  {{34.8286, 4.57815, -0.259835, 0.00424679},
						   {39.4437, 4.52068, -0.78184, 0.0893456}},
...
/*               {{97.15,  1.94998 , 0 , 0},{109.858, 1.19822 ,0, 0}}}; */
  ...
  //sector 4 has 2 gaps
  const Double_t fid_1gev_750_pimifid_S4[2][2][4] = {{{35.8238, 6.86212, -0.686454, 0.0249186}, {38.5397, 8.72133, -1.18367, 0.0582613}},
						     {{99.758,  1.35143  ,-0.115901,  0.0033244}, {111.575 , 0.00204503 , 0.122899 , -0.00687251}}};
  //sector 3 has 4 gaps
  const Double_t fid_1gev_750_pimifid_S3[3][2][4] = {//{{17.1438 , 5.82672 , -1.33914 , 0.370319},  {8.71859 , 23.4486 , -10.8172 , 1.97916}},
...
//2.2 GeV parameters
  ...
  //modified gap parameters for lower momentum range of pions, May 2023
  const Float_t fgPar_2GeV_2250_Pfid_ScpdS4[4][6] = {{94.5916, 18.0014, 18.3364, -41.7853, -80.3446, 116.192},
						     {101.77, 13.705, 20.2075, -33.6107, -70.4325, 100.421},  
						     {-137.480, 633.288, -954.383, 721.057, -269.140, 39.4822},
						     {-145.605, 697.662, -1088.74, 853.855, -330.883, 50.3421}};
  ...
  //modified gap parameters, May 2023
   const Float_t fgPar_2GeV_2250_Pfid_ScpdS5[8][6] = {{-29.9426, 370.963, -714.697, 707.343, -348.995, 67.7647},
						      {-67.8091, 632.756, -1321.25, 1369.59, -692.606, 136.198},
						      {-47.1617, 132.967, -104.776, 41.7673, -7.68238, 0.404311},
						      {-54.5895, 149.685, -111.590, 41.2556, -6.93943, 0.301087},
						      {-79.1386, 275.678, -341.972, 218.907, -69.5520, 8.66381},
						      {-97.5794, 352.616, -468.487, 322.829, -111.159, 15.0975},
  ...
  //sector 1 has 2 gaps
  const Double_t fid_2gev_2250_pimifid_S1[2][2][4]={{{113.956, 0.363286, 0.198558 ,-0.0144791}, {124.963, -1.25147, 0.390258, -0.0194753}},
